...
public class DataPacket implements Serializable {
	...
	public enum Request {
		...
		,GET_EXAMS_BY_TEACHER,START_EXAM,MANAGE_EXAMS,GET_NOT_IN_EXAM_QUESTIONS,
...
GET_ONGOING_EXAM, TERMINATE_EXAM
		...
		,GET_HOW_MANY_EXAMS, GET_IF_REQUEST, CHECK_FOR_EXAM, HOW_MANY_VERIFY, ONGOING_TO_MANAGE, CHECK_FOR_GRADES, GET_EXAM_QUESTIONID_BY_EID
	}
